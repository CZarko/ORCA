class Menu extends Phaser.Scene {
    ...
    create() {
        ...
        let clicker = this.add.sprite(xCentered + 250, game.config.height - vPadding*1.5,'clicker').setScale(0.1).setOrigin(0.5);
        clicker.anims.play('click');
        this.instructText = this.add.text(xCentered -75, clicker.y, 'Click to Play', {fontFamily: 'primaryFont', fontSize: '75px', align: 'center', color: '#000000', fixedWidth: 910}).setOrigin(0.5);
